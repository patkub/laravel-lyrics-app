    ...
    <form class="w-full" action="{{ route('add-lyrics.create') }}" method="POST">
        ...
        <div class="flex flex-wrap -mx-3 mb-3">
            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                <label class="block uppercase tracking-wide text-gray-700 dark:text-gray-100 text-xs font-bold mb-2" for="song-name">
                    Song Name
                </label>
                <input
                    ...
                    id="song-name"
                    name="song-name" type="text">
            </div>
            <div class="w-full md:w-1/2 px-3">
                <label class="block uppercase tracking-wide text-gray-700 dark:text-gray-100 text-xs font-bold mb-2" for="artist-name">
                    Artist Name
                </label>
                <input
        ...
        <div class="col-span-full">
            <label for="foreign" class="block text-sm/6 font-medium text-gray-900 dark:text-gray-100">Lyrics Foreign</label>
            <div class="mt-2">
                <textarea id="foreign" name="foreign" rows="3"
        ...
        <div class="col-span-full">
            <label for="english" class="block text-sm/6 font-medium text-gray-900 dark:text-gray-100">Lyrics English</label>
            <div class="mt-2">
                <textarea id="english" name="english" rows="3"
                    class="block w-full rounded-md bg-white dark:bg-gray-900 px-3 py-1.5 text-base text-gray-900 dark:text-white outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"></textarea>
            </div>
